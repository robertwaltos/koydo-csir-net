...
export const metadata: Metadata = {
  title: "Pricing — Csir Net Premium",
  description: "Unlock unlimited Csir Net practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=csir-net&cadence=annual`;
